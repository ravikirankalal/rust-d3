...
use rust_d3::axis::{axis_bottom, axis_left, AxisRenderable};
...
fn main() {
    ...
    let y = ScaleLinear::new([min_close as f64, max_close as f64], [(height - margin_bottom) as f64, _margin_top as f64]);
